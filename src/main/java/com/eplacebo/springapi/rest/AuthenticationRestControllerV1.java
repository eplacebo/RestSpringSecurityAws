...
import com.eplacebo.springapi.dto.AuthenticationRequestDTO;
import com.eplacebo.springapi.model.User;
import com.eplacebo.springapi.repository.UserRepository;
import com.eplacebo.springapi.security.JwtTokenProvider;
...
public class AuthenticationRestControllerV1 {
    ...
    public ResponseEntity<?> authenticate(@RequestBody AuthenticationRequestDTO request) {
        try {
            ...
            User user = userRepository.findUserByUsername(request.getUsername()).orElseThrow(() -> new UsernameNotFoundException("User doesn't exists"));
